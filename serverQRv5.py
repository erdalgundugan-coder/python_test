    ...
    def list_directory(self, path):
        ...
        for name in current_files:
            ...
            if ext in image_ext:
                ...
                # Video veya HEIC için thumbnail oluşturulmaz, ikon gösterilecek
                pass

        current_files.sort(key=lambda a: a.lower())
        ...
        html = [
            ...
            .gallery { display: flex; flex-wrap: wrap; justify-content: center; padding: 10px; gap:10px; }
            .gallery-item { cursor: pointer; border-radius: 8px; box-shadow: 0 0 5px #ccc; overflow: hidden; width: 160px; }
            .gallery-item img, .gallery-item video, .gallery-item .icon {
                display: block; max-width: 150px; max-height: 150px; margin: auto; border-radius: 8px; transition: transform 0.3s ease;
            }
        ...
        for idx, name in enumerate(current_files):
            ...
            if ext in image_ext:
                ...
                html.append(f'<video src="{full_url}" muted preload="metadata" style="max-width:150px; max-height:150px; border-radius:8px;"></video>')
                html.append("</div>")
                ...
                html.append(f'<div class="icon" style="width:150px; height:150px; line-height:150px; background:#ccc; color:#555; font-weight:bold; border-radius:8px;">HEIC</div>')
                html.append("</div>")
