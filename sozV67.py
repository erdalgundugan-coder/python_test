...
class LyricsSearcherApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Kamp Keyfi Şarkı Sözü Arama   -D:/sozler ve videolar/sozler-\nversion V67.0 Erdal GÜNDOĞAN-202509291455")
    ...
    def setup_ui(self):
        ...
        copy_btn = tk.Button(right_frame, text="→ Secili-Seçimsiz\nMetni dörtlük yap", command=self.dortluk_yap)
        ...
        save_jpeg_button = tk.Button(right_frame, text="Seçili Metni JPEG Kaydet", command=self.save_selected_text_as_jpeg)
