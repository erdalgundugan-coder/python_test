...
class LyricsSearcherApp:
    ...
    def highlight_text_in_result(self, filename, highlight_line_no=None):
        ...
        # Tag ayarları
        self.result_text.tag_configure("highlight_line", background="yellow")
    ...
    def open_floating_copy(self):
        ...
        if hasattr(self, "floating_win") and self.floating_win.winfo_exists():
            ...
            self.copy_text_area.tag_config("cursor_line", background="yellow")
    ...
    def toggle_dark_mode(self):
        ...
        if self.dark_mode_enabled:
            ...
            self.copy_text_area.configure(bg="white", fg="black", insertbackground="black")
