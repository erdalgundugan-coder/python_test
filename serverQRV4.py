...
class TkinterHTTPHandler(http.server.SimpleHTTPRequestHandler):
    ...
    def list_directory(self, path):
        ...
        html = [
            ...
            .gallery-item { cursor: pointer; border-radius: 8px; box-shadow: 0 0 5px #ccc; overflow: hidden; }
            .gallery-item img { display: block; max-width: 150px; height: auto; border-radius: 8px; transition: transform 0.3s ease; }
        ...
        for idx, name in enumerate(current_files):
            ...
            full_url = name
            html.append(f'<div class="gallery-item" data-index="{idx}" data-full="{full_url}">')
        ...
        <div id="modal">
            ...
            <img id="modal-img" src="" alt="Resim">
        ...
        function showModal(index) {
            currentIndex = index;
            const fullSrc = galleryItems[currentIndex].getAttribute('data-full');
        ...
        function showNext() {
            ...
            modalImg.src = galleryItems[currentIndex].getAttribute('data-full');
        }
...
class App(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Wi-Fi Resim Paylaşımı -V1.4 Erdal GÜNDOĞAN 2025")
