...
class LyricsSearcherApp:
    ...
    def setup_ui(self):
        ...
        self.btn_new_txt.pack(side="left", padx=10)
        tk.Button(search_frame, text="Asla Favori SEÇME_ME_LİSİN\nSoldaki şarkı İSMİ.TXT ye tıkla_altı çizili olsun\nŞarkı söz metni üzende işlem yap\n DEĞİŞİK_liğini yap ve ÜZERİNE KAYDET",command=self.save_file).pack(side="left")#bu satırı ekle buton aktif olur(,command=self.save_file).pack(side="left")
