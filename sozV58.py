...
class LyricsSearcherApp:
    ...
    def setup_ui(self):
        ...
        self.file_count_label.pack(side="bottom", padx=10)
    ...
    def search_in_all_files(self):
        ...
        for filename, lineno, line in total_results:
            ...
            # Son eklenen satırın index’i
            last_index = self.result_listbox.size() - 1  

            # Favori ise arka plan sarı boya
            if is_fav:
...
#.30.08.2025 hazırlan dı aramalr iyileşti,kayıt boyutu ayarlama çalışm devam