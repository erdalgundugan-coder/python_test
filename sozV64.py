...
class LyricsSearcherApp:
    ...
    def setup_ui(self):
        ...
        self.btn_new_txt.pack(side="left",ipadx=10, ipady=5, padx=(20, 20))
        tk.Button(search_frame, text="DOSYA ÜZERİNE KAYDET__HATA OLMAMASI İÇİN: \nSoldaki şarkı İSMİ.TXT ye tıkla_altı çizili olsun\nŞarkı söz metni üzende işlem yap\n DEĞİŞİK_liğini yap ve DOSYA ÜZERİNE KAYDET\n( Asla Favoriye TIKLAMA_MALI ve SEÇME_MELİ_SİN )_Yenile",command=self.emin_misin_save_file).pack(side="left",ipadx=40, ipady=5,fill="x")#bu satırı ekle buton aktif olur(,command=self.save_file).pack(side="left")
        ...
        self.dosya_entry = tk.Entry(right_frame, font=self.font_listbox, state="normal", readonlybackground="white",width=50)#altta dosya adı tutuyor
