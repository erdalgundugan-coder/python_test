...
class LyricsSearcherApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Şarkı Sözü Arama   version 1.54    Erdal GÜNDOĞAN-2025")
    ...
    def search_in_all_files(self):
        ...
        phrase = self.normalize(raw_input)  # tam ifade ("sen de")
        ...
        for filename in search_order:
            ...
            for lineno, line in enumerate(lines):
                if lineno >= y:
                    ...
                    # 1. Öncelikli kontrol: tam öbek ("sen de")
                    ...
                    # 2. İkinci kontrol: kelime kelime eşleşme
        ...
        # Önce tam eşleşenleri, sonra kısmi eşleşenleri birleştir
        final_results = exact_matches + partial_matches

        for filename, lineno, line in final_results:
